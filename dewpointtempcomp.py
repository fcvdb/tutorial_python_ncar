...
columns = {'date':0,'time':1,'tempout':2, 'humout':5, 'dewpoint':13}

# Data types for each column (only if non-string)
types = {'tempout': float, 'humout':float, 'dewpoint':float}
...
# heatindex= [compute_heatindex(t,h) for t, h zip (data['tempout'], data['humout'])]
...
print_comparison("DEW PT",data['date'], data['time'], data['dewpoint'] ,dewpoint)
#------------------------------------------------------------------------------#
